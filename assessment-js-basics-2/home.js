...
greetUser = (username) => `Welcome home ${username}`
...
function canWeDeliver(zipCode){
    if(deliveryAreaZipCodes.includes(zipCode)){
        return "Object eligible for delivery"
    } else {
        return "Object not in delivery zone"
    }
}
...
//CODE HERE
desc1 = deals[0].title.replace('15','10')
// console.log(desc1)
...
//CODE HERE
title2 = deals[1].desc.trim().replace('March','April')
// console.log(title2)